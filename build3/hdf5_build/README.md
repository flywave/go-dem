...
HDF5 2.2.0 that was compiled on;
    Darwin 24.6.0 arm64, using AppleClang C 17.0.0.17000604.
...
The contents of this directory are:
    ...
    README.md               - This file
    HDF5-2.2.0-Darwin.sh    - HDF5 Install Package
    OR
    HDF5-2.2.0-Darwin.tar.gz    - HDF5 Compressed Package
...
Installation
===========================================================================
1. Execute HDF5-2.2.0-Darwin.sh
2. Follow prompts
===========================================================================

Uncompress
===========================================================================
1. Extract HDF5-2.2.0-Darwin.tar.gz
===========================================================================
...
To test the installation with the examples;
    ...
    The default installation folder is defined as "/Users/xuning/Work/go-dem/libs/darwin_arm".
